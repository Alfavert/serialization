...
import S57Library.catalogs.S57AttributesCatalog;
...
public class S57AttributeField extends S57DataField {
	...
	public S57AttributeField(String tag, byte[] fieldData, S57DDRDataDescriptiveField fieldDefinition) throws Exception {
