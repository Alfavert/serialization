...
import S57Library.catalogs.S57ObjectsCatalog;
import S57Library.fiedsRecords.descriptive.S57DDRDataDescriptiveField;
import S57Library.objects.E_S57ObjectPrimitiveType;
...
public class S57FieldFRID extends S57IdentityField {	
	...
	public S57FieldFRID(String tag, byte[] fieldData, S57DDRDataDescriptiveField fieldDefinition) throws Exception {
		super(tag, fieldData, fieldDefinition);

		decode();	
	}

	// called by annotation
